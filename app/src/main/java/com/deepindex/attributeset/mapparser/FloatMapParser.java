...
public class FloatMapParser extends MapParser<Float> {
    public FloatMapParser(AttributeParser attributeParser) {
        super(attributeParser);
    }

    @Override
    public ArrayMap<String, Float> parse(String key, String type, XmlPullParser xmlPullParser)
            throws XmlPullParserException, IOException {
        return parseMap(key, type, xmlPullParser);
    }

    @Override
    protected Pair<String, Float> parseSubItem(String key, String type, XmlPullParser xmlPullParser)
        ...
        try {
            return Pair.create(subKey, Float.valueOf(value));
