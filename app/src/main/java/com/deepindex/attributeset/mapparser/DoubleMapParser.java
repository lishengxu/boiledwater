...
public class DoubleMapParser extends MapParser<Double> {
    public DoubleMapParser(AttributeParser attributeParser) {
        super(attributeParser);
    }

    @Override
    public ArrayMap<String, Double> parse(String key, String type, XmlPullParser xmlPullParser)
            throws XmlPullParserException, IOException {
        return parseMap(key, type, xmlPullParser);
    }

    @Override
    protected Pair<String, Double> parseSubItem(String key, String type, XmlPullParser xmlPullParser)
        ...
        try {
            return Pair.create(subKey, Double.valueOf(value));
