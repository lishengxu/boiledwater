...
public class ShortMapParser extends MapParser<Short> {
    public ShortMapParser(AttributeParser attributeParser) {
        super(attributeParser);
    }

    @Override
    public ArrayMap<String, Short> parse(String key, String type, XmlPullParser xmlPullParser)
            throws XmlPullParserException, IOException {
        return parseMap(key, type, xmlPullParser);
    }

    @Override
    protected Pair<String, Short> parseSubItem(String key, String type, XmlPullParser xmlPullParser)
        ...
        try {
            return Pair.create(subKey, Short.valueOf(value));
