...
public class LongMapParser extends MapParser<Long> {
    public LongMapParser(AttributeParser attributeParser) {
        super(attributeParser);
    }

    @Override
    public ArrayMap<String, Long> parse(String key, String type, XmlPullParser xmlPullParser)
            throws XmlPullParserException, IOException {
        return parseMap(key, type, xmlPullParser);
    }

    @Override
    protected Pair<String, Long> parseSubItem(String key, String type, XmlPullParser xmlPullParser)
        ...
        try {
            return Pair.create(subKey, Long.valueOf(value));
