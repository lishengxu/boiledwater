...
public class IntMapParser extends MapParser<Integer> {
    public IntMapParser(AttributeParser attributeParser) {
        super(attributeParser);
    }

    @Override
    public ArrayMap<String, Integer> parse(String key, String type, XmlPullParser xmlPullParser)
            throws XmlPullParserException, IOException {
        return parseMap(key, type, xmlPullParser);
    }

    @Override
    protected Pair<String, Integer> parseSubItem(String key, String type, XmlPullParser xmlPullParser)
        ...
        try {
            return Pair.create(subKey, Integer.valueOf(value));
