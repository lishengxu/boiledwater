...
public class AttributeListParser extends ListParser<AttributeParser.Attribute> {
    private static final int ATTRIBUTE_COUNT = 2;
    private final AttributeParseHelper mAttributeParseHelper;

    public AttributeListParser(AttributeParser attributeParser) {
...
//        mAttributeParseHelper.addSkipAttributeName(attributeName);
//    }
    ...
    @Override
    public ArrayList<AttributeParser.Attribute> parse(String key, String type, XmlPullParser xmlPullParser)
            throws XmlPullParserException, IOException {
    ...
    @Override
    protected AttributeParser.Attribute parseSubItem(String key, String type, XmlPullParser xmlPullParser)
