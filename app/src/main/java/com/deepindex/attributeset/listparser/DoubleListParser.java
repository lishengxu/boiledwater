...
public class DoubleListParser extends ListParser<Double> {
    public DoubleListParser(AttributeParser attributeParser) {
        super(attributeParser);
    }

    @Override
    public ArrayList<Double> parse(String key, String type, XmlPullParser xmlPullParser)
            throws XmlPullParserException, IOException {
        return parseList(key, type, xmlPullParser);
    }

    @Override
    protected Double parseSubItem(String key, String type, XmlPullParser xmlPullParser)
